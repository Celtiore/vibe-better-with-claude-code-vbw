...
```bash
MIGRATED_COUNT=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/migrate-config.sh --print-added .vbw-planning/config.json 2>/dev/null)
...
LEAD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh lead .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
DEV=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh dev .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
QA=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh qa .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
SCOUT=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh scout .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
DEBUGGER=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh debugger .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
ARCHITECT=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh architect .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
...
PROFILES_PATH="`!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json"

# Get current models (before changes)
LEAD_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh lead .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
DEV_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh dev .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
QA_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh qa .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
SCOUT_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh scout .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
DEBUGGER_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh debugger .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
ARCHITECT_OLD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh architect .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
...
```bash
CURRENT_LEAD=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh lead .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
CURRENT_DEV=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh dev .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
CURRENT_QA=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh qa .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
CURRENT_SCOUT=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh scout .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
```
...
```bash
CURRENT_DEBUGGER=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh debugger .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
CURRENT_ARCHITECT=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh architect .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
```
...
Run `bash `!`cat /tmp/.vbw-plugin-root`/scripts/suggest-next.sh config` and display.
...
OLD_MODEL=$(bash `!`cat /tmp/.vbw-plugin-root`/scripts/resolve-agent-model.sh "$AGENT" .vbw-planning/config.json `!`cat /tmp/.vbw-plugin-root`/config/model-profiles.json)
